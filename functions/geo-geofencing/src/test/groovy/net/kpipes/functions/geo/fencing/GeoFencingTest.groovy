...
class GeoFencingTest {
    ...
    void shouldCalculateDistanceFromPolygonFence() {
        ...
        // When
        def result = function.onEvent(new Event('key', [lat: 49.8209418, lng: 19.0551721], fenceConfig, null))
    ...
    void shouldReturnZeroForPointWithinPolygon() {
        ...
        // When
        def result = function.onEvent(new Event('key', [lat: 49.820888, lng: 19.054588], fenceConfig, null))
